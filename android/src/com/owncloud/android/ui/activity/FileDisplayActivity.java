...
public class FileDisplayActivity extends FileActivity implements OCFileListFragment.ContainerActivity,
    ...
    private BroadcastReceiver instantdownloadreceiver;
    ...
    protected void onAccountSet(boolean stateWasRecovered) {
        if (getAccount() != null) {
            ...
            if (file == null) {
                ...
                file = mStorageManager.getFileByPath(OCFile.PATH_SEPARATOR); // never
                                                                             // returns
                                                                             // null
            }
            setFile(file);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.action_create_file: {
             ...
             * OCFile f1 = getCurrentDir(); intent.putExtra("remotePath",
             * f1.getRemotePath()); CreateAndUploadFile cr = new
             * CreateAndUploadFile(); cr.createFile(f1.getRemotePath());
             */
            instantDownloadFile();
    ...
    protected void onResume() {
        ...
        IntentFilter instantDownloadIntentFilter = new IntentFilter("instantdownloadreceiver");
        registerReceiver(instantdownloadreceiver, instantDownloadIntentFilter);

        Log_OC.d(TAG, "onResume() end");
    }

    public class instantDownldreceiver extends BroadcastReceiver {
    ...
    public void onDismiss(EditNameDialog dialog) {
        if (dialog.getResult()) {
            ...
            if (newDirectoryName.length() > 0) {
                ...
                RemoteOperation operation = new CreateFolderOperation(path, getCurrentDir().getFileId(),
                        mStorageManager);
